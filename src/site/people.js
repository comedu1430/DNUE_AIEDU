...
const STATIC_STUDENT_PROFILES = {
  "2026": [
    { name: "Jaeeon Park", koName: "박재언", lab: "Member of the Panwoo Park Lab", koLab: "교수 연구실" },
    { name: "Kidong Kwon", koName: "권기동", lab: "Member of the Inhwan Yoo Lab", koLab: "교수 연구실" },
    { name: "Horyeon Nam", koName: "남호련", lab: "Member of the Youngkwon Bae Lab", koLab: "교수 연구실" },
    { name: "Jeongeun Choi", koName: "최정은", lab: "Member of the Wooyeol Kim Lab", koLab: "교수 연구실" },
    { name: "Eunjeong Lee", koName: "이은정", lab: "Member of the Youngho Lee Lab", koLab: "교수 연구실" },
    { name: "Jaeeun Yoon", koName: "윤재은", lab: "Member of the Jaekwon Shim Lab", koLab: "교수 연구실" },
  ],
  "2025": [
    { name: "Incheol Kim", koName: "김인철", lab: "Member of the Panwoo Park Lab", koLab: "유인환 교수 연구실" },
    { name: "Gukhwan Bae", koName: "배국환", lab: "Member of the Youngkwon Bae Lab", koLab: "박판우 교수 연구실" },
    { name: "Jaeeun Ahn", koName: "안재은", lab: "Member of the Inhwan Yoo Lab", koLab: "배영권 교수 연구실" },
    { name: "Youngtak Jeong", koName: "정영탁", lab: "Member of the Wooyeol Kim Lab", koLab: "이영호 교수 연구실" },
    { name: "Hyejeong Cho", koName: "조혜정", lab: "Member of the Jaekwon Shim Lab", koLab: "유인환 교수 연구실" },
    { name: "Minjeong Kang", koName: "강민정", lab: "Member of the Youngho Lee Lab", koLab: "유인환 교수 연구실" },
    { name: "Jungeun Kim", koName: "김정은", lab: "Member of the Panwoo Park Lab", koLab: "이영호 교수 연구실" },
    { name: "Daeryun Park", koName: "박대륜", lab: "Member of the Inhwan Yoo Lab", koLab: "유인환 교수 연구실" },
    { name: "Intae Hwang", koName: "황인태", lab: "Member of the Youngho Lee Lab", koLab: "심재권 교수 연구실" },
  ],
  "2024": [
    { name: "Jinhee Oh", koName: "오진희", lab: "Member of the Panwoo Park Lab", koLab: "김우열 교수 연구실" },
    { name: "Minji Lee", koName: "이민지", lab: "Member of the Inhwan Yoo Lab", koLab: "배영권 교수 연구실" },
